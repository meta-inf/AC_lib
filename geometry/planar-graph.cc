/*
 * Code for constructing dual graph for planar graph and point locating.
 * Last Edit : Feb 2013
 * */
...
//          fprintf(stderr, "Point 1 %d Point 2 %d\n", a, b);
    ...
    //  fprintf(stderr, "Mem usage = %d nodes(%.3f megabytes)\n", LOCATOR::tree::tot_cnt, LOCATOR::tree::tot_cnt * sizeof(LOCATOR::tree) / double(1048576));
    }
}
